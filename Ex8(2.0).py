...
"""
9 - Suponha que o conceito de um aluno seja determinado em função da sua nota. Suponha, também, que
esta nota seja um valor inteiro na faixa de 0 a 100, conforme a seguinte faixa:
...
"""
10 - Faça um programa que pergunte em que turno voce estuda. Peça para digitar M-matutino ou
